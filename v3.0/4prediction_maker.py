...
data2 = pd.read_csv('pok_gen2_w.csv', delimiter=';')
...
for index, row in data2.iterrows():
    predictions2.append(classify(row))

# Adicionar as previsões ao DataFrame
data['Prediction'] = predictions
data2['Prediction'] = predictions2
...
data2[['ID', 'Win', 'Prediction']].to_csv('predictions2.txt', sep='\t', index=False)
print("Dados salvos em 'predictions.txt' e 'predictions2.txt'")
